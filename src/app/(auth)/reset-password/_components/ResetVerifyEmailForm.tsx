...
export default function ResetVerifyEmailForm() {
  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-gradient-to-r from-purple-300 via-pink-400 to-red-500">
      <section className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
        ...
        <div>
          ...
          >
            <Link
              href="/"
              className="absolute top-[119px] right-[740px] border-2 border-pink-600 bg-black rounded-full p-2 text-white transition duration-300 transform hover:scale-125 hover:bg-white hover:text-black"
            >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            <div className="relative mb-16">
              <input
                ...
                className="w-full px-4 py-2 rounded border border-gray-300 bg-gray-50 text-gray-900 placeholder-gray-400 placeholder:italic focus:outline-none focus:ring-2 focus:ring-purple-500 pr-10 transition duration-300 transform hover:scale-105"
              />
              ...
              {showPassword ? (
                <FaEyeSlash
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 hover:scale-125 text-gray-500 cursor-pointer "
                />
              ) : (
                <FaEye
                  size={24}
          ...
          <div className="relative mb-2">
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-gradient-to-r from-purple-500 via-pink-600 to-red-700 px-4 py-2 text-lg font-semibold text-white shadow-sm hover:from-purple-700 hover:via-pink-700 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300 transform hover:scale-105 gap-4"
            >
              {isLoadingSubmit ? (
                <>
                  <Spinner /> Confirmando...
          ...
          <div className="relative mb-10">
            <button
              ...
              className="flex w-full justify-center rounded-md bg-gray-800 px-4 py-2 text-lg font-semibold text-white shadow-sm hover:from-gray-700 hover:to-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all duration-300 transform hover:scale-105 gap-4"
            >
              {isLoadingResend ? (
                <>
                  <Spinner /> Reenviando...
